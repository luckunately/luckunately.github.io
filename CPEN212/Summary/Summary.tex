...
\begin{itemize}
    ...
    \item \textbf{standard file descriptors}: \begin{itemize}
        \item \texttt{0}: standard input (stdin)
        \item \texttt{1}: standard output (stdout)
        \item \texttt{2}: standard error (stderr)
    \end{itemize}
    \item \textbf{file descriptor table}: a table that contains the file descriptors
    \item \textbf{file descriptor bitmap}: a bitmap that contains the free file descriptors 
\end{itemize}
