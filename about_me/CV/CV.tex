...
\begin{itemize}
\item Analyze memory access patterns in various CPU and memory intensive workloads; Predict page faults individually


with supervised learning methods (LSTM, Transformer, etc.); achieved better results than heuristic algorithms (LEAP).
\item Supervision under: Shaurya Patel, Prof. Alexandra Fedorova in UBC Systopia Lab.
\end{itemize}

\cvsection{Projects}

\cvevent{Evaluating Cache Scheduling Strategies for vLLM Inference}{Report avaliable at \href{https://luckunately.github.io/courses/CPEN511/Final_report.pdf}{\faGithub here}}{January 2025 -- April 2025}{Vancouver, BC}
\begin{itemize}
...
\cvevent{Capstone: Reinforcement Learning with SVT-AV1 Codec}{}{January 2025 -- August 2025}{Vancouver, BC}
\begin{itemize}
...
% \cvevent{Microsystem Design with Microprocessor}{}{Jan 2024 -- April 2024}{Vancouver, BC}
% \begin{itemize}
% \item Build {memory, data bus, various I/O} around a M68K CPU on FPGA. Interact with CPU using embedded C programming
% \item Implemented components including {DRAM and Cache Controller, SPI, Canbus, I2C, ADC/DAC}, and {Simple RTOS} with multi-threading and priority interrupts.
...
\cvevent{ECC Performance Analysis on FPGA}{Report avaliable at \href{https://github.com/luckunately/ELEC433-Projects/blob/main/Report/report_ieeeformat.pdf}{\faGithub here}}{Mar 2024 -- April 2024}{Vancouver, BC}
\begin{itemize}
...
\cvachievement{\faTrophy}{Dean's Honors List}{Academic Excellence Award 4 years in a row}
...
\cvtag{SystemVerilog} \cvtag{C} \cvtag{Python} 
\cvtag{tcl} \cvtag{Perl} \cvtag{Pytorch} \cvtag{QEMU} 
