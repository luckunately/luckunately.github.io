...
\tagline{For application of PUS/Wesbrook Awards}
...
\personalinfo{%
  ...
  \mailaddress{6335 Thuderbird Crest}
...
\cvevent{Student Research Asistant}{UBC}{Aprl 2024 -- Ongoing}{Vancouver, BC}
\begin{itemize}
...
\cvevent{IoT: Client and Server interaction}{}{Nov 2023 – Dec 2023}{}
\begin{itemize}
...
\begin{itemize}
  \item Registered in 24 credits this winter session
  \item Expecting to graduate in Aug 2025
\end{itemize}
...
\cvevent{BASC.\ in Computer Engineering}{University of British Columbia}{Sept 2021 -- Aug 2025}{}
CGPA: 87\% \\
...
\cvref{Prof.\ Alexandra (Sasha) Fedorova}{UBC}{sasha@ece.ubc.ca}
{Office: KAIS 4113}

\divider

\cvref{Prof.\ Farshid Agharebparast}{UBC}{farshid@ece.ubc.ca}
{Office: KAIS 3045}
