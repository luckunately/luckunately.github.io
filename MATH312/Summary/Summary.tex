...
\end{theorem}
The theorem gives a representation of $m$ in base b. $a_k$ is the highest digit and $a_0$ is the lowest digit. If $b=10$, then it is the normal decimal representation. fenrigberouigheroiug
