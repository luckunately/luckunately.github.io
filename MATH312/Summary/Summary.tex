...
\begin{enumerate}
    \item An integer $e$ is a common divisor of $a$ and $b$ if and only if $e | gcd(a, b)$.\begin{proof}
        ...
        If $e$ is a common divisor of $a$ and $b$, then $e | a$ and $e | b$. Therefore, $e | gcd(a, b) = ma + nb$ (Bezout's identity which will be proven below) for some $m, n \in \mathbb{Z}$. Therefore, $e | gcd(a, b)$.
...
\begin{proof}
    ...
    By definition, $d=x_0a+y_0b$ for some $x_0, y_0 \in \mathbb{Z}$ which is a linear combination of a and b. But we know that $gcd(a, b) | (ma + nb),\forall m, n \in \mathbb{Z}$. Also, $d = x_0a + y_0b$. Therefore, $gcd(a, b) | d$.
...
The Euclidean algorithm is a highly \textbf{recursive} and fast algorithm to find the gcd of two numbers. 
...
Let $a, b \in \mathbb{Z}, a \ge b \ge 1$. We let $a = bq + r$ where $0 \leq r < b$. Then $r < \frac{a}{2}$. \begin{proof}
    \begin{itemize}
        ...
        \item Case 2: $b > \frac{a}{2}$. Then $r = a - bq < a - \frac{a}{2}q = \frac{a}{2}(2-q) \leq \frac{a}{2}$. Given $q \ge 1$ since $a \ge b \le 0 \land r \ge 0$.
    \end{itemize}
\end{proof}
