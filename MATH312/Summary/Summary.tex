...
\begin{align*}
    p = 2 & 2^2-1=3 & \text{Mersenne prime}\\
    p = 3 & 2^3-1=7 & \text{Mersenne prime}\\
    p = 5 & 2^5-1=31 & \text{Mersenne prime}\\
    p = 7 & 2^7-1=127 & \text{Mersenne prime}\\
    p = 11 & 2^{11}-1=2047=23\times 89 & \text{Composite}\\
    p = 13 & 2^{13}-1=8191 & \text{Mersenne prime}\\
    p = 17 & 2^{17}-1=131071 & \text{Mersenne prime}\\
    p = 19 & 2^{19}-1=524287 & \text{Mersenne prime}\\
    p = 23 & 2^{23}-1=47\times 178481 & \text{Composite}\\
    p = 29 & 2^{29}-1=233\times 1103\times 2089 & \text{Composite}\\
    p = 31 & 2^{31}-1=2147483647 & \text{Mersenne prime}
\end{align*}
...
\begin{itemize}
    ...
    \item testing $n$ for primality means checking whether $n$ has any divisors other than 1 and $n$. Or in other words, check whether or not a factorization of $n$ exists.
\end{itemize}
