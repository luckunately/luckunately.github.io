...
\end{align*} 
Subtract both side, we get $26c\equiv -22 \pmod {28}$. Then $2c\equiv 22 \pmod {28}$. Note that $\gcd(2,22)=2$ so 2 does not have an inverse modulo 28. We have two possible solutions for it. 
...
Here $P=C=\mathbb{Z}_p$ where $p$ is a prime number. Let $n=p-1$. Let $a\in \mathbb{Z}_p$ with $\gcd(a,p)=1$.
\end{document}