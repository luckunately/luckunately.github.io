...
Another example, revisit: Find $17^{-1}\equiv 55$.
...
\begin{proof}
    ...
    Inductive step: Let $b$ be the unique solution to the system of \begin{align*}
...
In practice, to solve the system of linear congruences, we can use the following recursion. Let $N=n_1n_2\ldots n_r$. Then \begin{align*}
    x & \equiv a_1 \pmod {n_1} \\
    x & \equiv a_2 \pmod {n_2} \\
      & \vdots                 \\
    x & \equiv a_r \pmod {n_r}
