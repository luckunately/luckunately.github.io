...
With the Lemma in hand, we can start proving the theorem:\begin{proof}
    \begin{itemize}
        ...
        \item Now we need to show that every integer solution can be expressed in this form.
              ...
              Then $y-y_0 = -\frac{a}{d}t$ for some $t \in \mathbb{Z}$. Substitute it into
              the equation: \[
...
\begin{proof}
    ...
    \begin{itemize}
        ...
        \item $x_1=x_2+a_n,y_1=y_2+b_n$ Then $x_1y_1=x_2y_2+a(x_2y_2)+b(x_2n)+abn\equiv x_2y_2 \pmod n$ nfrubgnoeruvbgncuwhpocwhapuh
    \end{itemize}
\end{proof}
