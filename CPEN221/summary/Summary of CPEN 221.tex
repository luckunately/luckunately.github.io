...
Low level language can be translated directly to assembly and then machine language by the compliers. However high level languages like Java need an intermediate step. 
